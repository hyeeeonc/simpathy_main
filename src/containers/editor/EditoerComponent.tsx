    ...
    <>
      <EditorHeaderConatier>
        ...
        {boardType === 0 && selectedBoard === 19 && (
          <>
            <NoticeContainer>
              <strong>* 글을 작성해 주시면 따로 댓글이 달리지 않아도 신청이 된 것입니다.</strong>
              <br />
              <br />
              <strong>• 목동 시대인재 (수/18:30~22:00)</strong>
              <br />
              ...
              <br />
              <br />
              <strong>• 분당 대찬 (목/18:30~22:00)</strong>
              <br />
              학원 주소: 성남대로 389
              <br />
              학원 연락처: 031-712-5711
              ...
              <br />
              <br />
              <strong>• 대치 예섬 (금/18:30~22:00)</strong>
              <br />
